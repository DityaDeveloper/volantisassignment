...
class DityaSharedPreferences {
  DityaSharedPreferences._privateConstructor();

  static final DityaSharedPreferences instance =
      DityaSharedPreferences._privateConstructor();
